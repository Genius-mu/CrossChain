          ...
          >
            ...
            <div className="relative z-10">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full font-bold text-lg flex items-center gap-3 mx-auto shadow-2xl shadow-blue-500/50"
              >
                Launch Application
